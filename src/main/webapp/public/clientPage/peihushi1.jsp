...
<body>
    ...
    <div class="top_c">
        ...
        <p class="titi" style="float:right">陪护师选择</p>
        </div>
	...
	<form>
        ...
        <div class="yuesao_age" style="margin-top:20px; float:left; width:100%; border-top:1px  #E1E1E1 solid" >
        	<br/>
			<img src="images/peihushi/ph_target.png"
				style="margin: 0 15px 0px 10px; width: 1.5em; height: 1.5em"/> <span>陪护对象</span>
			<div style="margin: -22px 0px 0px 120px; width: 60%">
				<select id="escortperson"
					style="-webkit-appearance: none; border: none;  font-size: 16px; background: #FFF; margin-left:2em">
					<option value="幼儿陪护">幼儿陪护</option>
					<option value="中儿陪护">中儿陪护</option>
					<option value="大儿陪护">大儿陪护</option>
				</select>
			</div>
			<div style="margin: -21px 0px 0px 325px; float: right">
				<i class="iconfont icon-jiantou"></i>
        ...
        <div class="yuesao_age" style="margin-top:20px; float:left; width:100%; border-top:1px  #E1E1E1 solid" >
        	<br/>
			<img src="images/peihushi/ph_situation.png"
				style="margin: 0 15px 0px 10px; width: 1.5em; height: 1.5em"/> <span>自理情况</span>
			<div style="margin: -22px 0px 0px 120px; width: 60%">
				<select id="selfcare"
					style="-webkit-appearance: none; border: none;  font-size: 16px; background: #FFF; margin-left:2em">
					<option value="无法自理">无法自理</option>
					<option value="能自理">能自理</option>
				</select>
			</div>
			<div style="margin: -21px 0px 0px 325px; float: right">
				<i class="iconfont icon-jiantou"></i>
	...
	<script type="text/javascript">
		...
		function submit(){
			...
			dataObject.serveType = "3";//1月嫂，2催乳师，3陪护师
			...
			dataObject.escortperson = document.getElementById("escortperson").value; //陪护对象
			
			dataObject.selfcare = document.getElementById("selfcare").value; //自理情况
