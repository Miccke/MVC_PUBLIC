...
<script type="text/javascript">
	...
	function serve_dingdan(){
		...
		$.get("../../sWaiterOrder/serverNoEndlist",{openid:temp},function(data){
			...
			$('.shop').html('<div style="height:3em;"></div>'+ serve_dingdan+'<div style="height:3.8em;"></div>');
		},"json")
	}
...
<div>
	<div class="lie">
		...
		<div class="lie_bottom" style="float:left; width:100%; text-align:center; margin-top:10px;">
