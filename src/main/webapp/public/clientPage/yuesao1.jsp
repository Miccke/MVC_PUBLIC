...
<body>
    ...
    <div class="top_c">
        ...
        <p class="titi" style="float:right">月嫂选择</p>
        </div>
	...
	<form id="form">
		...
		<div class="check" id="check_box" style="float:left">
			<img src="images/cuirushi/cr_requirement.png"
				style="margin: 0 15px 0px 10px; width: 1.5em; height: 1.5em" /> <span>月嫂要求</span>
				<ul class="yuesao_ul_li" style="font-family: '微软雅黑'">
					...
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="月子餐" name="choose" id="yuezi" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 月子餐</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="经验" name="choose" id="exp" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 经验</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="专业" name="choose" id="pro" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 专业</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="口碑" name="choose" id="koubei" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 口碑</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="早教" name="choose" id="zaojiao" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 早教</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="性格" name="choose" id="xingge" /><img
							src="cr_requirement_nochoose.png"
							style="width: 1em; margin-right: 1em" class="check_img" /> 性格</span></li>
					<li><span onClick="check_li(this);"><input
							type="checkbox" value="个性定制" name="choose" id="gexing" /><img
							src="cr_requirement_nochoose.png"
		...
		<div class="yuesao_age" style="margin-top:20px; float:left; width:100%; border-top:1px  #E1E1E1 solid" >
			...
			<img src="images/cuirushi/cr_age.png"
				style="margin: 0 15px 0px 10px; width: 1.5em; height: 1.5em"/> <span>月嫂年龄</span>
		...
		<div class="yuesao_age" style="margin-top:20px; float:left; width:100%; border-top:1px #E1E1E1 solid" >
        	<br/>
			<img src="images/yuesao/yuesao_child_date.png"
				style="margin: 0 15px 0px 10px; width: 1.5em; height: 1.5em"/> <span>预产期</span>
			<div style="margin: -24px 0px 0px 120px; width: 60%">
				<input type="date" name="time" id="time_select"
		...
		<div class="person_info" style="padding: 20px 0 10px 0px; border-top:1px #E1E1E1 solid; float:left; width:100%">
			<p style="text-align: center; color: black; font-weight: 200;">————	个人信息 ————</p>
			<div class="person_info" id="info" style="margin: 20px 0 0 0">
				...
				<p><span style="font-size: 16px; color: gray; margin-left:1em">手机号</span> 
				...
				<p><span style="font-size: 16px; color: gray; margin-left:1em">备注</span> 
                    <input type="text" placeholder="备注信息..." name="msg"
						style="-webkit-appearance: none; border: none; margin-left: 40px; font-size: 16px;"></p>
				<p style="border-bottom:1px #E1E1E1 solid; width:100%"></p>
			</div>
	</div>
	...
	<script type="text/javascript"> 	
		...
		function submit(){
			...
			dataObject.ageBracket = select.value;//年龄
			
			
			var yuchanqi = document.getElementById("time_select");
			dataObject.dueDate = yuchanqi.value;//产期
